...
5. 设置页
   - 承载显示位置、动态岛模式、鼠标穿透、通知总开关、勿扰模式、勿扰时间、通知阈值、数据源、适配器启用状态。
