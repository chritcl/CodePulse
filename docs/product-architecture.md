...
9. 右键菜单由主进程提供，可执行打开当前任务、稍后提醒当前任务、展开、收起、隐藏、打开任务中心和打开设置。

打开 Agent、复制摘要等更多任务级菜单动作和 Windows 手测仍属于后续补强范围。
