...
5. 设置页
   - 承载动态岛模式、动态岛位置、固定/跟随显示器、目标显示器、自由坐标、鼠标穿透、全屏隐藏、通知总开关、勿扰模式、勿扰时间、通知阈值、数据源、适配器启用状态。
